...
public class AplikasiListTugas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        uDate.setDateFormatString("dd-MM-yyyy");
        uDate.setMaxSelectableDate(new java.util.Date(253370743273000L));
        uDate.setMinSelectableDate(new java.util.Date(-62135791127000L));
                    ...
                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(uNama, javax.swing.GroupLayout.DEFAULT_SIZE, 237, Short.MAX_VALUE)
    ...
    private void bSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSimpanActionPerformed
        ...
        if (uDate.getDate()!= null) {
            String formattanggal = "dd-MM-yyyy";
            SimpleDateFormat formattgl = new SimpleDateFormat(formattanggal);
            String dl = String.valueOf(formattgl.format(uDate.getDate()));
            deadline = dl;
        }
